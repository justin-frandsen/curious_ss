...
This report summarizes the preprocessing and analysis of behavioral and eye-tracking data from the Curious Search experiment. The design examines how scene-object associations influence search performance and eye movement behavior over learning.
...
## Behavioral Preprocessing (code hidden)

```{r Behavioral Preprocessing}
...
## RT Summary ANOVA and Linear-mixed effects
```{r BX Summary, echo = TRUE, collapse=FALSE, class.source='fold-show'}
...
## Interest Area Import
``` {r Interest Area Import}
...
## Fixation Summary
``` {r Fixation Summary, echo = TRUE, collapse=FALSE, class.source='fold-show'}
# Summarize fixations per trial
